...
{
    public class CharacterPanel_HotateBlack : MonoBehaviour
    {
        // このスクリプトをもつコンポーネントのキャラクター
        public static Characters character = Characters.HotateBlack;
        // キャラクターのマテリアル
        ...
        // キャラクターのボディーマテリアル
        public static Color characterBodyColor;
        ...
        static CharacterPanel_HotateBlack()
        {
        ...
        void Start()
        {
            ...
            characterBodyColor = bodyMaterial.color;
